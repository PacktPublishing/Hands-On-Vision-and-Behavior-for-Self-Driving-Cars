...
def save(name, images):
    cv2.imwrite("out_images/" + name, cv2.hconcat(images))

save("flip.jpg", [original,flipH, flipV, flip])
...
save("blur.jpg", [original, blurred, gaussian, median, bilateral])
...
save("cont_bright.jpg", [original, more_contrast, less_contrast, more_brightness, less_brightness])
...
save("gamma.jpg", [original, higher_gamma, lower_gamma])
