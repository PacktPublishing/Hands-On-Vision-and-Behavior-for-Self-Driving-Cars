...
#idx_split = int(len(file_names) * 0.8)
#val_size = len(file_names) - idx_split
...
#train_gen = generator2(x_train, y_train, batch_size)
#valid_gen = generator2(x_valid, y_valid, batch_size)
